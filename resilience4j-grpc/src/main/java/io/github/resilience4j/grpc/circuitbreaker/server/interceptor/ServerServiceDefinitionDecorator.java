...
public class ServerServiceDefinitionDecorator extends ServerCircuitBreakerDecorator {

    private final ServerServiceDefinition serverServiceDefinition;

    ServerServiceDefinitionDecorator(ServerServiceDefinition serverServiceDefinition) {

...
You can also invoke a decorated function asynchronously by using a `CompletableFuture` using a and chain further functions.
...
You can also invoke a decorated function by using a Reactive Streams implementation like https://github.com/ReactiveX/RxJava[RxJava] or https://github.com/reactor/reactor/[Project Reactor].

...
You can use https://dropwizard.github.io/metrics/[Dropwizard Metrics] to get execution metrics for your functions. A histogram allows you to measure min, mean, max, standard deviation and quantiles like the median or 95th percentile of function executions. A meter measures the rate of your function executions.

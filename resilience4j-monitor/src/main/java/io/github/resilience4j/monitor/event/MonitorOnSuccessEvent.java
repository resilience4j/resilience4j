...
import static io.github.resilience4j.monitor.event.MonitorEvent.Type.SUCCESS;

/**
 * A MonitorEvent which informs that the operation execution was successful.
 */
public class MonitorOnSuccessEvent extends AbstractMonitorEvent {

    private final Duration operationExecutionDuration;
    private final String resultName;

    public MonitorOnSuccessEvent(String monitorName, Duration operationExecutionDuration, String resultName) {

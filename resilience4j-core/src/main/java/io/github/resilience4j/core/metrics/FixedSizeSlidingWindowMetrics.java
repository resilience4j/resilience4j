...
/**
 * A {@link Metrics} implementation is backed by a sliding window that aggregates only the last {@code N} calls.
 *
 * The sliding window is implemented with a circular array of {@code N} measurements.

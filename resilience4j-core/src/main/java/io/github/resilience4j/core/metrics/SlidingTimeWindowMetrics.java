 ...
 * The other partial aggregations store the call outcomes of the previous {@code N-1} epoch seconds.
 *
 ...
 * Only {@code N} partial aggregations and 1 total total aggregation are created.
 */

...
[source,java,indent=0]
----
include::../../../../resilience4j-circuitbreaker/src/test/java/io/github/robwin/circuitbreaker/CircuitBreakerTest.java[tags=shouldInvokeMap]
----
...
[source,java,indent=0]
----
include::../../../../resilience4j-circuitbreaker/src/test/java/io/github/robwin/circuitbreaker/CircuitBreakerTest.java[tags=shouldChainDecoratedFunctions]
----
...
[source,java,indent=0]
----
include::../../../../resilience4j-circuitbreaker/src/test/java/io/github/robwin/circuitbreaker/CircuitBreakerTest.java[tags=shouldInvokeAsyncApply]
----
...
[source,java,indent=0]
----
include::../../../../resilience4j-circuitbreaker/src/test/java/io/github/robwin/circuitbreaker/CircuitBreakerTest.java[tags=shouldThrowCircuitBreakerOpenException]
----
...
[source,java,indent=0]
----
include::../../../../resilience4j-circuitbreaker/src/test/java/io/github/robwin/circuitbreaker/CircuitBreakerTest.java[tags=shouldInvokeRecoverFunction]
----
...
[source,java,indent=0]
----
include::../../../../resilience4j-circuitbreaker/src/test/java/io/github/robwin/circuitbreaker/CircuitBreakerTest.java[tags=shouldNotRecordIOExceptionAsAFailure]
----

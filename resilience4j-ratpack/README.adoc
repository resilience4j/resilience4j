...
methods returning types of promise and imperative objects. CircuitBreaker also supports methods returning
Observable and Flowable.

In the future, all annotations will also support methods returning CompletionStage.

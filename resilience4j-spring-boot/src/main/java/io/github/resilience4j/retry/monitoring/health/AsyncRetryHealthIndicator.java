 ...
 */
public class AsyncRetryHealthIndicator implements HealthIndicator {
	...
	public AsyncRetryHealthIndicator(AsyncRetry retry) {
		this.retry = retry;
	}
	...
	private Health mapBackendMonitorState(AsyncRetry retry) {
		AsyncRetry.Metrics metrics = retry.getMetrics();

...
public class TimerConfig {
    ...
    private static final String DEFAULT_ON_NO_FAILURE_TAG = "unspecified";
    private static final Supplier<String> DEFAULT_ON_SUCCESS_TAG_RESOLVER = () -> DEFAULT_ON_NO_FAILURE_TAG;
    ...
    private static final Function<?, String> DEFAULT_ON_RESULT_TAG_RESOLVER = result -> DEFAULT_ON_NO_FAILURE_TAG;

    @NonNull
    private final String metricNames;
    @NonNull
    private final Supplier<String> onSuccessTagResolver;
    @NonNull
    private final Function onResultTagResolver;
    @NonNull
    private final Function<Throwable, String> onFailureTagResolver;

    private TimerConfig(@Nullable String metricNames, @Nullable Supplier<String> onSuccessTagResolver, @Nullable Function<?, String> onResultTagResolver, @Nullable Function<Throwable, String> onFailureTagResolver) {
        this.metricNames = requireNonNullElse(metricNames, DEFAULT_METRIC_NAMES);
        this.onSuccessTagResolver = requireNonNullElse(onSuccessTagResolver, DEFAULT_ON_SUCCESS_TAG_RESOLVER);
     ...
     */
    public Supplier<String> getOnSuccessTagResolver() {
        return onSuccessTagResolver;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", TimerConfig.class.getSimpleName() + "[", "]")
                ...
                .add("onSuccessTagResolver=" + onSuccessTagResolver)
    ...
    public static class Builder<T> {
        ...
        @Nullable
        private Supplier<String> onSuccessTagResolver;
        @Nullable
        ...
        private Builder(@NonNull TimerConfig prototype) {
            ...
            onSuccessTagResolver = prototype.getOnSuccessTagResolver();
        ...
        /**
         * @param onSuccessTagResolver A function that resolves a tag for a successfully executed decorated void operation.
         *                             Default is {@value DEFAULT_ON_NO_FAILURE_TAG}.
         * @return the TimerConfig.Builder
         */
        public Builder<T> onSuccessTagResolver(@Nullable Supplier<String> onSuccessTagResolver) {
            this.onSuccessTagResolver = onSuccessTagResolver;
            return this;
        }
        ...
        public TimerConfig build() {
            return new TimerConfig(metricNames, onSuccessTagResolver, onResultTagResolver, onFailureTagResolver);
        }
    }
}

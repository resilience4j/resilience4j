...
public class TaggedCircuitBreakerMetricsTest {
    ...
    public void shouldAddMetricsForANewlyCreatedCircuitBreaker() {
        ...
        assertThat(taggedCircuitBreakerMetrics.meterIdMap.get("backendA")).hasSize(17);
        assertThat(taggedCircuitBreakerMetrics.meterIdMap.get("backendB")).hasSize(17);
    ...
    public void shouldAddCustomTags() {
        ...
        assertThat(taggedCircuitBreakerMetrics.meterIdMap.get("backendF")).hasSize(17);
        List<Meter> meters = meterRegistry.getMeters();
        assertThat(meters).hasSize(34);

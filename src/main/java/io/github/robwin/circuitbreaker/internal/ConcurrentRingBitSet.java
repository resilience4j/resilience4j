 ...
 */
public class ConcurrentRingBitSet {
     ...
     *                                    is negative
     */
    public ConcurrentRingBitSet(int bitSetSize) {
        notFull = true;
        size = bitSetSize;
    ...
    /**
     * Returns the number of bits set to {@code true} in this {@code ConcurrentRingBitSet}.
     *
     * @return the number of bits set to {@code true} in this {@code ConcurrentRingBitSet}
     */
     ...
     * {@code ConcurrentRingBitSet} to represent bit values.
    ...
    /**
     * Returns the "logical size" up to the maximum size of this {@code ConcurrentRingBitSet}.
     * Returns zero if the {@code ConcurrentRingBitSet} contains no set bits.
     *
     * @return the logical size of this {@code ConcurrentRingBitSet}
     */
    public int length() {
        return length;
    }
    ...
    /**
     * Returns the current index of this {@code ConcurrentRingBitSet}.
     * Use only for debugging and testing
     *
     * @return the current index of this {@code ConcurrentRingBitSet}
     */

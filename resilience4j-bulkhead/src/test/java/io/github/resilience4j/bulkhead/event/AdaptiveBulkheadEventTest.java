...
public class AdaptiveBulkheadEventTest {
    ...
    @Before
    public void init() {
        eventData.put("test1", "test1");
    }

    @Test
    public void testLimitIncreasedEvent() {
        BulkheadOnLimitIncreasedEvent bulkheadOnLimitIncreasedEvent = new BulkheadOnLimitIncreasedEvent("test",
            eventData);
    ...
    public void testLimitDecreasedEvent() {
        BulkheadOnLimitDecreasedEvent bulkheadOnLimitDecreasedEvent = new BulkheadOnLimitDecreasedEvent("test",
            eventData);
    ...
    public void testLimitIgnoreEvent() {
        BulkheadOnIgnoreEvent bulkheadOnIgnoreEvent = new BulkheadOnIgnoreEvent("test", eventData);
    ...
    public void testLimitSuccessEvent() {
        BulkheadOnSuccessEvent bulkheadOnSuccessEvent = new BulkheadOnSuccessEvent("test",
            eventData);
    ...
    public void testLimitOnErrorEvent() {
        BulkheadOnErrorEvent bulkheadOnErrorEvent = new BulkheadOnErrorEvent("test", eventData);

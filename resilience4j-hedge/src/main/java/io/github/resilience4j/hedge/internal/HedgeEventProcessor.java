...
public class HedgeEventProcessor extends EventProcessor<HedgeEvent> implements
    ...
    public Hedge.EventPublisher onPrimarySuccess(
        ...
        registerConsumer(PrimarySuccessEvent.class.getSimpleName(), onSuccessEventConsumer);
        return this;
    }
    ...
    public Hedge.EventPublisher onPrimaryFailure(
        ...
        registerConsumer(PrimaryFailureEvent.class.getSimpleName(), onFailureEventConsumer);
        return this;
    }
    ...
    public Hedge.EventPublisher onHedgeSuccess(
        ...
        registerConsumer(HedgeSuccessEvent.class.getSimpleName(), onHedgeSuccessEventConsumer);
        return this;
    }
    ...
    public Hedge.EventPublisher onHedgeFailure(
        ...
        registerConsumer(HedgeFailureEvent.class.getSimpleName(), onOnFailureEventConsumer);
        return this;
    }
}